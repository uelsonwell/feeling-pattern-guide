...
export const PORTAS: { id: PortaId; nome: string; descricao: string }[] = [
  ...
  },
  {
    id: "CV",
    nome: "Culpa/Vergonha",
    descricao: "A resposta se volta para dentro: responsabilidade, dúvida e exposição de si.",
  },
  {
    id: "RAI",
    nome: "Raiva",
...
export type Codificacao = {
  ...
  primary_gate: PortaId;
  primary_gate_weight: Peso;
  secondary_gate: PortaId | null;
  secondary_gate_weight: 1 | null;
};
...
const alt = (
  ...
  gate: PortaId,
  gateW: Peso,
  extras: Partial<Pick<Codificacao, "secondary_experience" | "secondary_experience_weight" | "secondary_gate" | "secondary_gate_weight">> = {},
): Alternativa => ({
  option,
  texto,
...
export const QUESTOES: Questao[] = [
  // ───────────── BLOCO 1 — REJEIÇÃO
  {
    ...
    alternativas: [
      ...
      alt("D", "Tento explicar melhor minha escolha para que a pessoa compreenda e volte a me apoiar.", "REJ", 2, "MED", 1, { secondary_gate: "CV", secondary_gate_weight: 1 }),
    ],
  },
  {
    question_id: "R02",
    ...
    alternativas: [
      alt("A", "Sinto que talvez não seja tão importante para aquelas pessoas quanto imaginava.", "REJ", 2, "MED", 2, { secondary_gate: "CV", secondary_gate_weight: 1 }),
      ...
      alt("D", "Tento descobrir o motivo e entender o que aconteceu antes de tirar conclusões.", "REJ", 2, "MED", 1),
    ],
  },
  {
    question_id: "R03",
    ...
    alternativas: [
      ...
      alt("D", "Tento entender por que aquela pessoa me enxerga daquela maneira.", "REJ", 2, "MED", 1),
    ],
  },
  {
    question_id: "R04",
    ...
    alternativas: [
      ...
      alt("B", "Fico preocupado(a) com a imagem que aquela pessoa passou a ter de mim.", "REJ", 2, "MED", 2, { secondary_gate: "CV", secondary_gate_weight: 1 }),
      alt("C", "Sinto raiva porque parece que meu esforço não foi reconhecido.", "REJ", 2, "RAI", 2),
      alt("D", "Tenho vontade de fazer ainda mais para provar que consigo.", "REJ", 2, "CV", 1, { secondary_gate: "MED", secondary_gate_weight: 1 }),
    ],
  },
  ...
  // ───────────── BLOCO 2 — ABANDONO
  {
    ...
    alternativas: [
      ...
      alt("D", "Também me afasto para não demonstrar que aquilo me afetou.", "ABA", 2, "MED", 1, { secondary_gate: "RAI", secondary_gate_weight: 1 }),
    ],
  },
  {
    question_id: "A02",
  ...
  },
  {
    ...
    alternativas: [
      ...
      alt("B", "Começo a me perguntar o que há de errado comigo.", "ABA", 2, "CV", 2, { secondary_experience: "REJ", secondary_experience_weight: 1 }),
  ...
  },
  {
    ...
    alternativas: [
      ...
      alt("D", "Procuro me afastar emocionalmente para não sofrer caso a relação termine.", "ABA", 2, "MED", 1, { secondary_gate: "RAI", secondary_gate_weight: 1 }),
    ],
  },
  ...
  // ───────────── BLOCO 3 — MANIPULAÇÃO
  {
    ...
    alternativas: [
      ...
      alt("D", "Tento explicar minhas razões várias vezes até a pessoa aceitar minha decisão.", "MAN", 2, "CV", 1, { secondary_gate: "MED", secondary_gate_weight: 1 }),
    ],
  },
  {
    question_id: "M02",
    ...
    alternativas: [
      ...
      alt("D", "Passo a justificar minhas decisões para tentar fazer a pessoa entender.", "MAN", 2, "CV", 1, { secondary_gate: "MED", secondary_gate_weight: 1 }),
    ],
  },
  {
    question_id: "M03",
    ...
    alternativas: [
      alt("A", "Acabo cedendo para não correr o risco de perder a relação.", "MAN", 2, "MED", 2, { secondary_experience: "ABA", secondary_experience_weight: 1 }),
      ...
      alt("D", "Tento negociar até encontrar uma forma de fazer a pessoa desistir da ameaça.", "MAN", 2, "MED", 1),
    ],
  },
  {
    question_id: "M04",
    ...
    alternativas: [
      alt("A", "Começo a pensar que talvez eu realmente esteja exagerando.", "MAN", 2, "MED", 1, { secondary_gate: "CV", secondary_gate_weight: 1 }),
      alt("B", "Fico envergonhado(a) por ter criado aquela situação.", "MAN", 2, "CV", 2, { secondary_experience: "HUM", secondary_experience_weight: 1 }),
      alt("C", "Fico muito irritado(a) porque sinto que o problema foi colocado sobre mim.", "MAN", 2, "RAI", 2),
      alt("D", "Tento voltar ao assunto original e explicar novamente o que aconteceu.", "MAN", 2, "RAI", 1),
    ],
  },
  ...
  // ───────────── BLOCO 4 — HUMILHAÇÃO
  {
    ...
    alternativas: [
      ...
      alt("D", "Tento agir como se aquilo não tivesse importância.", "HUM", 2, "MED", 1, { secondary_gate: "RAI", secondary_gate_weight: 1 }),
    ],
  },
  {
    question_id: "H02",
    ...
    alternativas: [
      alt("A", "Começo a questionar se minha ideia realmente era tão boa.", "HUM", 2, "CV", 2, { secondary_experience: "REJ", secondary_experience_weight: 1 }),
      ...
      alt("D", "Tento explicar minha ideia ainda melhor para mostrar que ela está errada.", "HUM", 2, "RAI", 1),
    ],
  },
  {
    question_id: "H03",
    ...
    alternativas: [
      alt("A", "Quero desaparecer daquela situação.", "HUM", 2, "MED", 1, { secondary_gate: "CV", secondary_gate_weight: 1 }),
      ...
      alt("D", "Tento rir da situação e agir como se não tivesse sido nada demais.", "HUM", 2, "MED", 1),
    ],
  },
  {
    question_id: "H04",
    ...
    alternativas: [
      alt("A", "Aquilo fica ecoando dentro de mim e começo a questionar meu próprio valor.", "HUM", 2, "CV", 2, { secondary_experience: "REJ", secondary_experience_weight: 1 }),
      ...
      alt("D", "Tento mostrar que aquilo não me atinge.", "HUM", 2, "MED", 1, { secondary_gate: "RAI", secondary_gate_weight: 1 }),
    ],
  },
  ...
  // ───────────── BLOCO 5 — TRAIÇÃO
  {
    ...
    alternativas: [
      ...
      alt("D", "Passo a desconfiar de tudo o que aquela pessoa me diz.", "TRA", 2, "MED", 1, { secondary_gate: "RAI", secondary_gate_weight: 1 }),
    ],
  },
  {
    question_id: "T02",
    ...
    alternativas: [
      ...
      alt("D", "Fico abalado(a) e começo a rever mentalmente tudo o que aconteceu.", "TRA", 2, "MED", 1),
    ],
  },
  {
    question_id: "T03",
    ...
    alternativas: [
      alt("A", "Fico pensando por que esconderam aquilo de mim.", "TRA", 2, "CV", 1, { secondary_gate: "MED", secondary_gate_weight: 1 }),
      alt("B", "Sinto-me diminuído(a) por terem decidido que eu não deveria saber.", "TRA", 2, "CV", 2, { secondary_experience: "HUM", secondary_experience_weight: 1 }),
      alt("C", "Fico muito irritado(a) e quero saber quem decidiu esconder aquilo.", "TRA", 2, "RAI", 2),
      alt("D", "Passo a desconfiar que outras coisas também podem estar sendo escondidas.", "TRA", 2, "MED", 1),
    ],
  },
  {
    question_id: "T04",
    ...
    alternativas: [
      ...
      alt("D", "Passo a me proteger e tenho dificuldade para confiar novamente.", "TRA", 2, "MED", 1, { secondary_gate: "RAI", secondary_gate_weight: 1 }),
    ],
  },
];

export const TOTAL_QUESTOES = QUESTOES.length;
/** Máximo operacional por célula da matriz 5×3 (4 situações × 2 pontos). */
